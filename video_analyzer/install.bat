...
python -c "try:%NL%    from deepface import DeepFace%NL%    DeepFace.analyze(img_path='modules/__init__.py', actions=['emotion'], enforce_detection=False, silent=True)%NL%except:%NL%    pass%NL%print('  Emotion model ready.')"
